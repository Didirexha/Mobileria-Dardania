          ...
          <div className="space-y-8">
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full bg-gray-800 text-white px-8 py-4 font-semibold text-lg tracking-wider rounded-md shadow-lg hover:bg-gray-900 transition duration-300 flex items-center justify-center"
              >
